...
class ManageDoctor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // declare variable in Markdown table
      contentMarkdown: "",
      contentHTML: "",
      selectedOption: "",
      description: "",
      ...
      // declare variable in doctor_infor table
      listPrice: [],
      listPayment: [],
      listProvince: [],
      listClinic: [],
  ...
  handleChangeSelectDoctorInfor = async (selectedOption, name) => {
    ...
    console.log("check new onChange: ", selectedOption, name, stateName);
  };
  ...
  render() {
    ...
    return (
      <div className="manage-doctor-container">
        ...
        <div className="more-infor">
          <div className="content-left form-group">
            ...
            <Select
              ...
              placeholder={
                <FormattedMessage id="admin.manage-doctor.select-doctor-input" />
              }
            />
          </div>
        ...
        <div className="extra-infor row">
          <div className="col-4 form-group">
            ...
            <Select
              ...
              placeholder={
                <FormattedMessage id="admin.manage-doctor.price-input" />
              }
              name="selectedPrice"
            />
          </div>
          <div className="col-4 form-group">
            ...
            <Select
              ...
              placeholder={
                <FormattedMessage id="admin.manage-doctor.payment-method-input" />
              }
          ...
          <div className="col-4 form-group">
            ...
            <Select
              ...
              placeholder={
                <FormattedMessage id="admin.manage-doctor.select-province-input" />
              }
        ...
        {/* current */}
        <div className="row specialty-select">
          <div className="col-4 form-group">
            <label>
            ...
            <Select
              ...
              onChange={this.handleChangeSelectDoctorInfor}
              placeholder={
                <FormattedMessage id="admin.manage-doctor.specialty-input" />
              }
          ...
          {/* <div className="col-4 form-group">
            ...
            <Select
              ...
              onChange={this.handleChangeSelectDoctorInfor}
              placeholder={
                <FormattedMessage id="admin.manage-doctor.clinic-input" />
              }
              name="selectedClinic"
            />
          </div> */}
