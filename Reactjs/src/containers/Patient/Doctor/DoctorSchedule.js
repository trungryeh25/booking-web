...
class DoctorSchedule extends Component {
  ...
  render() {
    let { allDays, allAvailableTime, isOpenModalBooking, dataScheduleModal } =
      this.state;
    let { language } = this.props;
    return (
      <>
                ...
                <>
                    ...
                    {allAvailableTime.map((item, index) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => this.handleClickSetTime(item)}
                        >
                          {timeDisplay}
                        </button>
                      );
                  ...
                  <div className="choose-booking">
                    <span>
                      ...
                      <FormattedMessage id="patient.detail-doctor.choose-booking" />
                    </span>
                  </div>
                </>
              ) : (
